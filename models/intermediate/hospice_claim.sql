...
select
    ...
    , {{ try_to_cast_date('coalesce(c.claim_start_date,b.clm_hospc_start_dt_id,b.clm_thru_dt)', 'DD-MON-YYYY') }} as claim_start_date
    ...
    , {{ try_to_cast_date('b.clm_hospc_start_dt_id', 'DD-MON-YYYY') }} as admission_date
    ...
    , cast(hcpcs_2nd_mdfr_cd as {{ dbt.type_string() }} ) as hcpcs_modifier_1
